...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ themes('css/template/reset.css') }}" type="text/css" media="screen">
        <link rel="stylesheet" href="{{ themes('css/template/style.css') }}" type="text/css" media="screen">
        <link rel="stylesheet" href="{{ themes('css/template/grid.css') }}" type="text/css" media="screen">
        <link rel="icon" href="{{ themes('images/template/favicon.ico') }}" type="image/x-icon">
        <link rel="shortcut icon" href="{{ themes('images/template/favicon.ico') }}" type="image/x-icon">
        <link href="http://fonts.googleapis.com/css?family=PT+Serif+Caption:400,400italic" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="{{ themes('css/template/flexslider.css') }}" type="text/css" media="screen">
