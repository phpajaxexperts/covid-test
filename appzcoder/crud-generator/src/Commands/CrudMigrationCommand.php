...
class CrudMigrationCommand extends GeneratorCommand
{
    ...
    protected function getPath($name)
    {
        ...
        $this->moduleName = $this->option('module-name');
        //echo base_path().'/Modules/'.$this->moduleName.'/Database/migrations/'; exit;


        return base_path().'/Modules/'.$this->moduleName.'/Database/migrations/' . $datePrefix . '_create_' . $name . '_table.php';
    ...
    protected function buildClass($name)
    {
        ...
        if ($schema) {
            ...
            foreach ($fields as $field) {
                ...
                $data[$x]['options'] = trim($fieldArray[2]);
        ...
        if($softDeletesSnippets){
            ...
            \$table->timestamps();" . $tabIndent . $tabIndent . $tabIndent .
                "});";
        }else{
            //echo $schemaFields; exit;
