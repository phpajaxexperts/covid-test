...
class CrudModelCommand extends GeneratorCommand
{
    ...
    protected function buildClass($name)
    {
        ...
        //echo $this->option('modelname'); exit;
...
EOD;
        ...
        $ret = $this->replaceModelNamespace($stub, $name)
    ...
    protected function replaceModelNamespace(&$stub, $modelNamespace)
    {
        ...
        //echo $modelNamespace;
        //echo '\\'.substr($this->option('table'),0,strlen($this->option('table'))-1); exit;
        //$modelNamespace = str_replace('\\'.substr(ucfirst($this->option('table')),0,strlen($this->option('table'))-1),'' , $modelNamespace);
        //$modelNamespace = str_replace('\\'.str_singular(ucfirst($this->option('table'))),'' , $modelNamespace);
        $modelNamespace = $this->str_lreplace('\\'.str_singular(ucfirst(str_replace(' ','',$this->option('modelname')))),'' , $modelNamespace);

        $stub = str_replace('DummyNamespace', $modelNamespace, $stub);
