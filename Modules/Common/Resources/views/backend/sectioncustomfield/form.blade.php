...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        <input class="form-control" name="section_rs" type="hidden" id="section_rs" value="{{ isset($sectioncustomfield->section_rs) ? $sectioncustomfield->section_rs : ''}}" >
        <input class="form-control" name="section" type="hidden" id="section" value="{{ isset($sectioncustomfield->section) ? $sectioncustomfield->section : ''}}" >
    </div>
</div>
