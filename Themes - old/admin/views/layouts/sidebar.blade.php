    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{ themes('images/avatar.png')  }}" class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @foreach($modules as $module)
                @if($module->permission_name)
                <?
                    //dd(Auth::guard('administrator'));
                    //dd(Auth::user());
                    //print_r(explode(',',$module->permission_name)); exit;

                    //echo "Permission : ".Auth::guard('administrator')->user()->hasAnyPermission(explode(',',$module->permission_name)).'<br>';     
                            ...
                            @if(count($module_sections)>0)
                                ...
                                @foreach($module_sections as $module_section)
                                    @if(Auth::guard('administrator')->user()->hasAnyPermission($module_section->permission_name) || Auth::guard('administrator')->user()->hasPermissionTo('Super Admin'))
                                        <li><a href="{{ route($module_section->permission_name) }}"><i class="fa fa-circle-o"></i> {{ $module_section->name  }}</a></li>
                                    @endif
                                @endforeach
                                </ul>
                            @endif
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Adminisitration</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{ route('View Administrator') }}"><i class="fa fa-circle-o"></i> Adminisitrator</a></li>
                    <li><a href="{{ route('View Role') }}"><i class="fa fa-circle-o"></i> Roles</a></li>
                    <li><a href="{{ route('View Permission') }}"><i class="fa fa-circle-o"></i> Permissions</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
